...
namespace chem {
    ...
    class ChemSimReactionKey {friend class CCylinder;
                            friend class CompartmentGrid<1>;
                            friend class CompartmentGrid<2>;
                            friend class CompartmentGrid<3>;
    ...
    public:
        ...
        void setInstance(ChemSimInitKey k, ChemSimImpl *csi);
