...
CylindricalZBoundaryElement::CylindricalZBoundaryElement(vector<double> coords, double radius, double height, double repulsConst, double sceenLength)
...
double CylindricalZBoundaryElement::distance(const vector<double>& point) {
    ...
    if(point[2] > (_coords[2] + _height / 2) || point[2] < (_coords[2] - _height / 2)) return numeric_limits<double>::infinity();
...
double CylindricalZBoundaryElement::stretchedDistance(const vector<double>& point, const vector<double>& force, double d) {
    ...
    return _radius - TwoPointDistance({_coords[0],_coords[1], 0}, {(point[0] + d * force[0]), (point[1] + d * force[1]) ,0});
}
...
HalfSphereZBoundaryElement::HalfSphereZBoundaryElement(vector<double> coords, double radius, bool up, double repulsConst, double sceenLength)
