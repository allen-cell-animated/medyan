...
- Improved performance for neighbor list and binding site search. Binding site search now gains SIMD support. (See *file-name* for detailed performance benchmark)
