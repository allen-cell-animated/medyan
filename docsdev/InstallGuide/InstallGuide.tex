...
\hline
 ...
 \hline
  ...
  Pair-wise distance protocols\\
    \vtop{\hbox{\strut NLORIGINAL}\hbox{\strut  HYBRID\_NLSTENCILLIST}\hbox{\strut SIMDBINDINGSEARCH}} & \vtop{\hbox{\strut Enable system mechanics.}\hbox{\strut Serial implementation of conjugate gradient}} \\ 
  \hline\hline
