...
\section{Performance updates in Medyan4.0}
 ...
 \hline
  \vtop{\hbox{\strut \textbf{Volume}} \hbox{\strut $\mu m^3$}} & \textbf{\# actin monomers} & \textbf{\# actin segments} & \vtop{\hbox{\strut \textbf{MEDYAN3.2}}\hbox{\strut d-days or h-hours}} & \vtop{\hbox{\strut \textbf{MEDYAN4.0}}\hbox{\strut d-days or h-hours}} \\
   \hline
