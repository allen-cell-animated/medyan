...
\hline
 ...
 \hline
  ...
  \hline
  DLUNBINDINGTYPE & CATCHSLIP, SLIP & Cross-linker unbinding dynamic rate form. If CATCHSLIP, two
  parameters for DLUNBINDINGLEN and DLUNBINDINGAMP are needed to define the functional form. If SLIP, one 
  ...
  \hline
    DMUNBINDINGTYPE & CATCHSLIP, SLIP & Myosin II unbinding dynamic rate form. If CATCHSLIP, two
  parameters for DMUNBINDINGLEN and DMNBINDINGAMP are needed to define the functional form. If SLIP, one 
  DMUNBIDINGLEN is needed to define the functional form. \\
  \hline
  DMUNBINDINGLEN & double & Characteristic length of myosin II unbinding dynamic rate form \\
  \hline
   DMUNBINDINGAMP & double & Amplitude of myosin II unbinding dynamic rate form \\
  \hline
  DMWALKINGTYPE & EXPSTALL & Myosin II walking dynamic rate form \\ 
  \hline
  DMWALKINGLEN & double & Characteristic length of myosin II walking dynamic rate form \\
  \hline
