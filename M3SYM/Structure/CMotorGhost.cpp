...
CMotorGhost::CMotorGhost(short motorType, Compartment* c,
    ...
    SpeciesBound* se1 = _cc1->getCMonomer(_position1)->speciesBound(motorBindingSite);
    SpeciesBound* se2 = _cc2->getCMonomer(_position2)->speciesBound(motorBindingSite);
...
void CMotorGhost::createOffReaction(ReactionBase* onRxn, SubSystem* ps) {
    ...
    Species* empty1 = _cc1->getCMonomer(_position1)->speciesBound(motorBindingSite);
    Species* empty2 = _cc2->getCMonomer(_position2)->speciesBound(motorBindingSite);
...
void CMotorGhost::moveMotorHead(CCylinder* cc,
    ...
    if(getFirstSpecies() == smOld) {
        ...
        Species* seOther = _cc2->getCMonomer(_position2)->speciesBound(motorBindingSite);
        ...
        Species* seOther = _cc1->getCMonomer(_position1)->speciesBound(motorBindingSite);
