...
double FilamentBendingCosine::energy(Bead* b1, Bead* b2, Bead* b3, double kBend, double eqTheta){
...
double FilamentBendingCosine::energy(Bead* b1, Bead* b2, Bead* b3, double kBend, double eqTheta, double d ){
...
void FilamentBendingCosine::forces(Bead* b1, Bead* b2, Bead* b3, double kBend, double eqTheta ){
...
void FilamentBendingCosine::forcesAux(Bead* b1, Bead* b2, Bead* b3, double kBend, double eqTheta ){
