...
void BranchingBendingCosine::forces(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
    ...
    b1->force[0] +=
        k * ((b3->coordinate[0] - b4->coordinate[0])*A +
             (b2->coordinate[0] - b1->coordinate[0])*B );
    b1->force[1] +=
        k * ((b3->coordinate[1] - b4->coordinate[1])*A +
             (b2->coordinate[1] - b1->coordinate[1])*B );
    b1->force[2] +=
        k * ( (b3->coordinate[2] - b4->coordinate[2])*A +
    ...
    b3->force[0] +=
        k *((b1->coordinate[0] - b2->coordinate[0])*A +
            (b4->coordinate[0] - b3->coordinate[0])*C );
    b3->force[1] +=
        k *((b1->coordinate[1] - b2->coordinate[1])*A +
            (b4->coordinate[1] - b3->coordinate[1])*C );
    b3->force[2] +=
...
void BranchingBendingCosine::forcesAux(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
                                       double kBend, double eqTheta ){
    ...
    //force on i, f = k*(-A*l2 + 2*B*l1):
    b1->forceAux[0] +=
        k * ((b3->coordinateAux[0] - b4->coordinateAux[0])*A +
             (b2->coordinateAux[0] - b1->coordinateAux[0])*B );
    b1->forceAux[1] +=
        k * ((b3->coordinateAux[1] - b4->coordinateAux[1])*A +
             (b2->coordinateAux[1] - b1->coordinateAux[1])*B );
    b1->forceAux[2] +=
        k * ((b3->coordinateAux[2] - b4->coordinateAux[2])*A +
    ...
    //force on j, k*(-A*l1 + 2*C*l2):
    b3->forceAux[0] +=
        k *((b1->coordinateAux[0] - b2->coordinateAux[0])*A +
            (b4->coordinateAux[0] - b3->coordinateAux[0])*C );
    b3->forceAux[1] +=
        k *((b1->coordinateAux[1] - b2->coordinateAux[1])*A +
            (b4->coordinateAux[1] - b3->coordinateAux[1])*C );
    b3->forceAux[2] +=
        k *((b1->coordinateAux[2] - b2->coordinateAux[2])*A +
            (b4->coordinateAux[2] - b3->coordinateAux[2])*C );
