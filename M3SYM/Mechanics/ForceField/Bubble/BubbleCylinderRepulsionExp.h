...
public:
    double computeEnergy(Bead*, Bead*, double, double, double);
    double computeEnergy(Bead*, Bead*, double, double, double, double);
    
    void computeForces(Bead*, Bead*, double, double, double);
    void computeForcesAux(Bead*, Bead*, double, double, double);
};
