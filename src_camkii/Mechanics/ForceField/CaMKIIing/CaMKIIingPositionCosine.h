...
#ifndef MEDYAN_CaMKIIingPositionCosine_h
#define MEDYAN_CaMKIIingPositionCosine_h
...
/// A cosine potential used by the CaMKIIingPosition template.
class CaMKIIingPositionCosine {
