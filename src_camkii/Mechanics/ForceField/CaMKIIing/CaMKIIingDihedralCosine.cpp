...
double CaMKIIingDihedralCosine::energy(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
...
void CaMKIIingDihedralCosine::forces(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
                                     double kDihed, double position){
...
void CaMKIIingDihedralCosine::forcesAux(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
                                     double kDihed, double position){
