...
\begin{DoxyCompactList}\small\item\em Manages callbacks for \hyperlink{classRSpecies}{R\+Species} and Reactions objects. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
typedef \\*
