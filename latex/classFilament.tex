...
\begin{DoxyCompactList}\small\item\em Reset delta. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Get delta. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This class contains information about \hyperlink{classCylinder}{Cylinders} and \hyperlink{classBead}{Beads} connectivity. It has functionality to polymerize and depolymerize, as well as extend and retract by creating and deleting \hyperlink{classCylinder}{Cylinder} and \hyperlink{classBead}{Bead} in the system.
