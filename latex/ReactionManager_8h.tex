...
\begin{DoxyCompactList}\small\item\em Manager for polymerization at plus end of \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
class \hyperlink{classPolyMinusEndManager}{Poly\+Minus\+End\+Manager}
\begin{DoxyCompactList}\small\item\em Manager for polymerization at minus end of \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
class \hyperlink{classDepolyPlusEndManager}{Depoly\+Plus\+End\+Manager}
\begin{DoxyCompactList}\small\item\em Manager for depolymerization at plus end of \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
class \hyperlink{classDepolyMinusEndManager}{Depoly\+Minus\+End\+Manager}
\begin{DoxyCompactList}\small\item\em Manager for depolymerization at minus end of \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
class \hyperlink{classBasicBindingManager}{Basic\+Binding\+Manager}
\begin{DoxyCompactList}\small\item\em Manager for basic binding to \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
class \hyperlink{classUnbindingManager}{Unbinding\+Manager}
\begin{DoxyCompactList}\small\item\em Manager for all unbinding from \hyperlink{classFilament}{Filament}. \end{DoxyCompactList}\item 
