...
\begin{DoxyCompactList}\small\item\em Setter functions for movables. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Setter function for reactables. \end{DoxyCompactList}\end{DoxyCompactItemize}
