...
\end{DoxyNote}
This class also has functions to add the filament reaction to a \hyperlink{classCCylinder}{C\+Cylinder}, as well as add a connection reaction between two neighboring \hyperlink{classCCylinder}{C\+Cylinders}. 
