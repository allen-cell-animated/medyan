...
\begin{DoxyCompactList}\small\item\em Used to control the geometry of the \hyperlink{classCompartmentGrid}{Compartment\+Grid}, as well as the geometry of entire system. \end{DoxyCompactList}\end{DoxyCompactItemize}
