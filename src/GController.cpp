...
Compartment* GController::getRandomCompartment() {
    ...
    while(true) {
	 ...
	 //Qin
         _grid[2] * _compartmentSize[2] * Rand::randDouble(0.2,0.8)};
...
vector<double> GController::getRandomCoordinates(Compartment* c) {
    ...
    //Qin
    coords.push_back(coordsCompartment[2] + _compartmentSize[2] * Rand::randDouble(-0.7,0.7) / 2);
...
vector<double> GController::getRandomCoordinates() {
    ...
    //Qin
    coords.push_back(Rand::randDouble(0.2,0.8) * _grid[2] * _compartmentSize[2]);
