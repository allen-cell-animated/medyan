...
private:
    floatingpoint _F0;  ///< characteristic force
    floatingpoint _dutyRatio = 1.0;
    
public:
    MotorSlip(short motorType, floatingpoint charForce)
...
public:
    TwoHeadStall(short motorType, short filamentType, floatingpoint charForce, floatingpoint walkingRate)
