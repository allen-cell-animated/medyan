...
//        std::cout<<SysParams::CParams.brancherBoundIndex[filType]<<" "<<SysParams::CParams
//                .linkerBoundIndex[filType]<<" "
//                ""<<SysParams::CParams`
//                .motorBoundIndex[filType]<<endl;
...
//std::cout<<SysParams::CParams.brancherBoundIndex[filType]<<" "<<SysParams::CParams.linkerBoundIndex[filType]<<" "<<
//           SysParams::CParams.motorBoundIndex[filType]<<endl;
//        for(auto j=0; j<SysParams::CParams.bindingIndices[filType].size(); j++)
//            std::cout<<SysParams::CParams.bindingIndices[filType].at(j)<<endl;
//        exit(EXIT_FAILURE);
...
////                if(GController::getCompartmentID(C->coordinates()) == 0){
////                    SysParams::Chemistry().bindingmanagerlist.append("B");
////                    if(nzstr == "ALL")
////                        SysParams::Chemistry().bmanagerdistances.push_back(0.0);
////                    else if(nzstr == "BOUNDARY")
////                        SysParams::Chemistry().bmanagerdistances.push_back(1.0);
////                    else if(nzstr == "TOPBOUNDARY")
////                        SysParams::Chemistry().bmanagerdistances.push_back(2.0);
////                    SysParams::Chemistry().bmanagerdistances.push_back(nucleationDist);
////                }
//#endif
...
////                if(GController::getCompartmentID(C->coordinates()) == 0){
////                    SysParams::Chemistry().bindingmanagerlist.append("L");
////                    SysParams::Chemistry().bmanagerdistances.push_back(rMin);
////                    SysParams::Chemistry().bmanagerdistances.push_back(rMax);
////                }
//#endif
...
////                if(GController::getCompartmentID(C->coordinates()) == 0){
////                    SysParams::Chemistry().bindingmanagerlist.append("M");
////                    SysParams::Chemistry().bmanagerdistances.push_back(rMin);
////                    SysParams::Chemistry().bmanagerdistances.push_back(rMax);
////                }
//#endif
            ...
            if((lManager = dynamic_cast<LinkerBindingManager*>(manager.get()))) {
                ...
                auto nl =
                        new CylinderCylinderNL(lManager->getRMax() + SysParams::Geometry().cylinderSize[filType],
                                               max(lManager->getRMin() - SysParams::Geometry().cylinderSize[filType],
                                                   0.0), true);
...
//#endif
                ...
                auto nl =
                        new CylinderCylinderNL(mManager->getRMax() + SysParams::Geometry().cylinderSize[filType],
                                               max(mManager->getRMin() - SysParams::Geometry().cylinderSize[filType],
                                                   0.0), true);
