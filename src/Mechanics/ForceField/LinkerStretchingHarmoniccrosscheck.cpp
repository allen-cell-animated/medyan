...
#ifdef CROSSCHECK
floatingpoint LinkerStretchingHarmonic::energy(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
...
floatingpoint LinkerStretchingHarmonic::energy(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
    ...
    floatingpoint distStretched = twoPointDistance(v1, v2) - eqLength;
//    std::cout<<distStretched<<endl;
    return 0.5 * kStretch * distStretched * distStretched ;
    
}
floatingpoint LinkerStretchingHarmonic::forces(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
                                        floatingpoint position1, floatingpoint position2,
                                        floatingpoint kStretch, floatingpoint eqLength){
...
floatingpoint LinkerStretchingHarmonic::forcesAux(Bead* b1, Bead* b2, Bead* b3, Bead* b4,
                                           floatingpoint position1, floatingpoint position2,
                                           floatingpoint kStretch, floatingpoint eqLength){
