...
double TriangleCylinderBeadExclVolRepulsion::loadForces(Triangle* t, const array<double, 3>& coord, double kExVol) {
    ...
    // array<double, 3> dA = {{}};
    // array<double, 3> dB = {{}};
    array<double, 3> dC = {{ 2 * (cb[0] - c0[0]), 2 * (cb[1] - c0[1]), 2 * (cb[2] - c0[2]) }};
    array<double, 3> dD = {{ 2 * (c0[0] - c1[0]), 2 * (c0[1] - c1[1]), 2 * (c0[2] - c1[2]) }};
    array<double, 3> dE = {{ 2 * (c1[0] - c2[0]), 2 * (c1[1] - c2[1]), 2 * (c1[2] - c2[2]) }};
    array<double, 3> dF = {{ 2 * (c1[0] - c0[0]), 2 * (c1[1] - c0[1]), 2 * (c1[2] - c0[2]) }};
