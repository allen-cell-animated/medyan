...
double CaMKIIingPositionCosine::energy(Bead* b1, Bead* b2, Bead* b3,
...
void CaMKIIingPositionCosine::forces(Bead* b1, Bead* b2, Bead* b3,
                                     double kPosition, double position ){
...
void CaMKIIingPositionCosine::forcesAux(Bead* b1, Bead* b2, Bead* b3,
                                     double kPosition, double position ){
