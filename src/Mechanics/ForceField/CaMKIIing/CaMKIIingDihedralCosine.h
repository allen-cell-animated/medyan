...
#ifndef MEDYAN_CaMKIIingDihedralCosine_h
#define MEDYAN_CaMKIIingDihedralCosine_h
...
/// A cosine potential used by the CaMKIIingDihedraltemplate.
class CaMKIIingDihedralCosine {
