...
#ifndef MEDYAN_BoundaryCylinderAFMRepulsion_h
#define MEDYAN_BoundaryCylinderAFMRepulsion_h
...
class BoundaryCylinderAFMRepulsion : public BoundaryInteractions {
...
public:
    ...
    virtual const string getName() {return "Boundary-Cylinder Repulsion in AFM condition";}
};
#endif
