...
namespace mathfunc {
    ...
    vector<double> TwoPointDirection(std::vector<double> v1, std::vector<double> v2) {
    ...
    vector<double> NextPointProjection(std::vector<double> coordinate, double d, std::vector<double> tau){
    ...
    double ScalarProduct(std::vector<double> v1, std::vector<double> v2, std::vector<double> v3, std::vector<double> v4){ return ( (v2[0]-v1[0])*(v4[0]-v3[0]) + (v2[1]-v1[1])*(v4[1]-v3[1]) +(v2[2]-v1[2])*(v4[2]-v3[2]) );}
    ...
    std::vector<double> MidPointCoordinate(std::vector<double> v1, std::vector<double> v2, double alpha){
        std::vector<double> v;
